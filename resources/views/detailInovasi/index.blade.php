                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <input type="text" class="form-control" id="namaInovasi" placeholder="Pembangunan Sistem Manajemen Inovasi Smart City" disabled>
                                                            </div>
                                                            <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <textarea class="form-control" id="penjelasanInovasi" rows="3" placeholder="Aplikasi ini digunakan untuk mengelola data Inovasi Smart City" disabled></textarea>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="manfaatInovasi">Manfaat Inovasi</label>
                                                                <textarea class="form-control" id="manfaatInovasi" rows="3" placeholder="Sebagai wadah pendataan Inovasi Smart City yang diajukan oleh Perangkat Daerah atau Masyarakat" disabled></textarea>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="keunikanInovasi">Keunikan/Kreativitas Inovasi</label>
                                                                <textarea class="form-control" id="keunikanInovasi" rows="3" placeholder="Data setiap Inovasi dapat dilihat sejarah setiap tahapannya dan untuk kemitraan memiliki fitur penilaian" disabled></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <textarea class="form-control" id="potensiPengembangan" rows="3" placeholder="Pengembangan fitur lainnya" disabled></textarea>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="strategiKeberlangsungan">Strategi Menjaga Keberlangsungan</label>
                                                                <textarea class="form-control" id="strategiKeberlangsungan" rows="3" placeholder="Melakukan transfer knowledge kepada Perangkat Daerah dan sosialisasi kepada masyarakat" disabled></textarea>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="analisisRisiko">Analisis Risiko</label>
                                                                <textarea class="form-control" id="analisisRisiko" rows="3" placeholder="-" disabled></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <textarea class="form-control" id="potensiPengembangan" rows="3" placeholder="APBD Tahun 2020" disabled></textarea>
                                                            </div>
                                                            <!-- <div class="col-md-4">
                                                                <label for="strategiKeberlangsungan">Strategi Menjaga Keberlangsungan</label>
